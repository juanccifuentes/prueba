...
<?php require_once('codigos/cotizaciones.php'); ?>
<?php 
...
<?php
	...
	echo '<thead><tr align="center"><td>Proforma</td><td>Cliente</td><td>Descripcion</td><td>Fecha de Inicio</td><td>Estado</td><td colspan="6">opciónes</td></tr></thead>';
...
<td><a href="codigos/actualizarcotizacion.php?id_cotizacion=<?php echo $fila['id_cotizacion']?>">
      ...
      <td><a href="cambiarestado.php?id=<?php echo $fila['id_cotizacion']?>" rel="moodalbox 400 150">Estado</a></td>
     <?php  } 
	 }?>
